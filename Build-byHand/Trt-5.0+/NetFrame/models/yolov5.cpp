...
ICudaEngine* createEngine(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt ) {
    ...
    IConvolutionLayer* convl101 = network->addConvolutionNd(*l100->getOutput(0), 3 * (Yolo::CLASS_NUM + 5), DimsHW{1, 1}, weightMap["module_list.101.Conv2d.weight"], weightMap["module_list.101.Conv2d.bias"]);
    assert(convl101);
    // 102 is yolo layer
