...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov5m.cfg', help='cfg file path')
    parser.add_argument('--data', type=str, default='data/VOC_Infrared/Ultralytics/infrared.data', help='*.data file path')
    parser.add_argument('--weights', type=str, default='yolov5s/weights/best.pt', help='sparse model weights')
    ...
    compact_model_name = f'yolo_hand_shortcut_pruning_{str(percent)}percent.weights'
