...
wdir = "yolov5m" + '/weights' + os.sep  # weights dir
last = wdir + 'last.pt'
best = wdir + 'best.pt'
results_file = 'yolov5/results.txt'
...
# Overwrite hyp with hyp*.txt (optionamal)
f = glob.glob('hyp*.txt')
if f:
    print('Using %s' % f[0])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov5m.cfg', help='*.cfg path')
    parser.add_argument('--t_cfg', type=str, default='', help='teacher model cfg file path for knowledge distillation')
    parser.add_argument('--data', type=str, default='data/VOC_Infrared/Ultralytics/infrared.data', help='*.data path')
    parser.add_argument('--multi-scale', action='store_true', help='adjust (67%% - 150%%) img_size every 10 batches')
    parser.add_argument('--img-size', nargs='+', type=int, default=[640, 640, 640], help='[min_train, max-train, test]')
    ...
    parser.add_argument('--pretrain', '-pt', dest='pt',  default="/home/fusion/CX/SOFTWARE/cx/YOLOv3v4-ModelCompression-MultidatasetTraining-Multibackbone-master/yolov5/weights/best.pt", action='store_true',
                        help='use pretrain model')
    parser.add_argument('--s', type=float, default=0.00001, help='scale sparse rate')
