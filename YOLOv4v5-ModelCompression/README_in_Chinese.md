...
5、YOLOv4
```bash
python train.py --data data/VOC_Infrared/Ultralytics/infrared.data --batch-size 2 -pt --weights weights/model/yolov4.weights --cfg weights/model/yolov4.cfg --img_size 608
```
...
```
python train.py --cfg weights/model/yolov4.cfg --data data/VOC_Infrared/Ultralytics/infrared.data --weights weights/best.weights --epochs 300 --batch-size 2 -sr --s 0.001 --prune 1"
```
其中：
...
```bash
python train.py --data ... -pt --batch-size 32  --weights ... --cfg ... -sr --s 0.001 --prune 0 
```
