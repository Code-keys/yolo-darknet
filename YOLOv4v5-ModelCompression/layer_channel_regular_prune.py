...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='weights/2_prune_300epoch_0.0001s/yolov4.cfg', help='cfg file path')
    parser.add_argument('--data', type=str, default='data/VOC_Infrared/Ultralytics/infrared.data', help='*.data file path')
    parser.add_argument('--weights', type=str, default='weights/2_prune_300epoch_0.0001s/last.pt', help='sparse model weights')
    parser.add_argument('--shortcuts', type=int, default=1, help='how many shortcut layers will be pruned,\
        pruning one shortcut will also prune two CBL,yolov3 has 23 shortcuts')
    parser.add_argument('--percent', type=float, default=0.3, help='global channel prune percent')
    parser.add_argument('--layer_keep', type=float, default=0.4, help='channel keep percent per layer')
