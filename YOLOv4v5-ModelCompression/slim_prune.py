...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='weights/pre_model/yolov4.cfg', help='cfg file path')
    parser.add_argument('--data', type=str, default='data/VOC_Infrared/Ultralytics/infrared.data',
                        help='*.data file path')
    parser.add_argument('--weights', type=str, default='weights/1_prune_300epoch_0.0001s/last.pt', help='sparse model weights')
    parser.add_argument('--percent', type=float, default=0.9, help='global channel prune percent')
    ...
    save_weights(compact_model, path=pruned_cfg_name.replace(".cfg", ".weights"))
